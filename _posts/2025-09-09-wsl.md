...
<figure class="align-center" align="center">
    ...
    <img
    src="{{ 'assets/images/2025-09-09-wsl/8.png' || relative_url }}"
    loading="lazy" decoding="async"
    style="max-width:20%; height:auto; border-radius:8px;">
...
<figure class="align-center" align="center">
    <img
    src="{{ 'assets/images/2025-09-09-wsl/9.png' || relative_url }}"
    loading="lazy" decoding="async"
    style="max-width:30%; height:auto; border-radius:8px;">
...
<figure class="align-center" align="center">
    <img
    src="{{ 'assets/images/2025-09-09-wsl/10.png' || relative_url }}"
    loading="lazy" decoding="async"
    style="max-width:30%; height:auto; border-radius:8px;">
